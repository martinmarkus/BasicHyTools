package hu.martinmarkus.basichytools.gamefunctions.generalfunctions.teleportationfunctions.warp;

import hu.martinmarkus.basichytools.gamefunctions.GameFunction;
import hu.martinmarkus.basichytools.models.User;

public class DeleteWarp<T> extends GameFunction<T> {

    public DeleteWarp(User executor /*add other function params*/) {
        super(executor, "");
